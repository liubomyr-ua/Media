(function (Q, $, window, undefined) {
    ...
    Q.Tool.define("Media/webrtc/call/preview", ["Media/webrtc/preview"], function _Media_webrtc_preview (options, parentPreviewTool) {
...

        {
            ...
            templates: {
                view: {
                    name: 'Media/webrtc/call/preview/view',
...

        {
            refresh: function (stream) {
                ...
                function updateTitle() {
                    Q.req('Media/calls', 'callParticipants', function (err, response) {
    ...
    Q.Template.set('Media/webrtc/call/preview/view',
        '<div class="Streams_preview_container Streams_preview_view Q_clearfix">'
        + '<img alt="{{alt}}" class="Streams_preview_icon">'
        + '<div class="Streams_preview_contents {{titleClass}}">'
        + '<{{titleTag}} class="Streams_preview_preamble">{{preamble}} <span class="Media_webrtc_duration">{{duration}}</span></{{titleTag}}>'
